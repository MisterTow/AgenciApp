...
class HomeInquilino extends StatefulWidget {
  HomeInquilino({Key? key}) : super(key: key);

  @override
  _HomeInquilino createState() => _HomeInquilino();
}

class _HomeInquilino extends State<HomeInquilino> {
